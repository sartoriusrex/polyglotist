  ...
  return (
    <>
      <section id={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p>
            ...
            leaving the page, and review learned vocabulary with spaced
            repetition
          </p>
      ...
      <section className={styles.landingSection}>
        ...
        <p>
          Looking up words while reading is annoying. Doing it in another
          language is worse. Polyglotist takes foreign texts, strips out
          everything unnecessary, and allows readers to immediately look up
          words while reading--without ever leaving the page.
        </p>
      </section>
      ...
      <section className={`${styles.landingSection} ${styles.stripedSection}`}>
        <div className={styles.stripedSectionContent}>
          ...
          >
            ...
            <p>
              Use timed reptition flashcards to solidify your vocabulary and
              track your progress.
            </p>
          </div>
        </div>
      ...
      <footer>
        ...
        <p>
          Copyright Dennis Mai Development Services {fullyear} | All rights
          reserved
        </p>
      </footer>
    </>
